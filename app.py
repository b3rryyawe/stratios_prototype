...
st.markdown(""" You are the CEO of a global EV manufacturer, dependant on lithium supplied from Sub-Saharan Africa. Recent armed conflict in the region has lead to insurgents seizing key mining sites and cutting transport routes to export ports. As a result your supply has been compromised.
""")
